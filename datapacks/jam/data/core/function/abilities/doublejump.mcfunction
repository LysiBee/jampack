...
execute as @a[scores={dj=2..}] at @s if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{type_specific:{type:"minecraft:player",input:{jump:1b}}}} run summon wind_charge ~ ~ ~ {Motion:[0.0,-0.1,0.0]}
